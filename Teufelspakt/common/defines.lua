...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.40, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.30, 
	GOLD_TO_CASH_RATE = 0, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 0.05, -- Multiplier for how much money gold pays to pops
	...
	INVESTMENT_SCORE_FACTOR = 0.000, -- how much foreign investment money counts towards your industry score
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 50, -- TODO base value that is powered by level of naval base. Determines the naval supplying capabilities. 
...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 10.0,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 10.0,	-- how fast pops are Hired when there is a medium demand
	...
	TRADE_CAP_LOW_LIMIT_LAND = 0.35, 				-- the lowest % the slider can go for land units
	TRADE_CAP_LOW_LIMIT_NAVAL = 0.35, 			-- the lowest % the slider can go for naval units
...
military = {
	...
	SIEGE_BRIGADES_BONUS = 0.2, -- the bonus to siege speed from each brigade
...
pops = {
	...
	IMMIGRATION_SCALE = 0.00025,

	PROMOTION_SCALE = 0.0025,
	PROMOTION_ASSIMILATION_CHANCE = 0.0025,
	...
	SLAVE_GROWTH_DIVISOR = 1.00, -- Slaves have N times lower growth
...
ai = {
	...
	INDUSTRYWORKER_WEIGHT = 4.4, -- ai weight for new industry workers
	EDUCATOR_WEIGHT = 4.3, -- ai weigth for new clergy
	...
	PRODUCTION_WEIGHT = 6.0, -- ai weight for new production
